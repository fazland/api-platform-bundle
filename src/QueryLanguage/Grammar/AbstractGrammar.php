...
abstract class AbstractGrammar
{
    ...
    private const YYLAST = 54;
    private const YY2TBLSTATE = 6;
    private const YYGLAST = 19;

    private const YYSTATES = 74;
    ...
    */
    ...
    private $yyaction = [
           ...
           15,   42,   43,   44,   46,   16,   45,    6,   33,   14,
           56,   28,   68,    5,    0, -32766,   34, -32766,   14,   29,
           46,    1,    2,    0,    3,   34,   51,    4,    7,    8,
            9,    0,   22,    0,   48,    0,   49,   52,   53,   57,
           55,   54,    0,   10,
    ];

    private $yycheck = [
            3,    4,    5,    6,    7,    8,    9,   10,   11,    2,
           13,   14,   15,   16,   17,   18,    3,   20,    2,   12,
           21,   22,   21,   22,    0,    4,   19,   20,   12,   17,
           17,   20,   22,   -1,   20,   19,   21,   20,   20,   20,
           20,   -1,   20,   -1,   21,   -1,   21,   21,   21,   21,
           21,   21,   -1,   22,
    ];

    private $yybase = [
           16,   16,   16,    7,   -3,   21,   13,   13,   13,   13,
           13,   -1,    1,   11,   18,   19,   20,   24,   22,   14,
           17,   15,   23,   25,   31,   10,   26,   27,   12,   28,
           29,   30,   -3,   -3,   -3,   -3,    0,   -3,
    ];

    private $yydefault = [
           43,   43,   43, 32767,   26, 32767, 32767, 32767, 32767, 32767,
    ...
    private $yygoto = [
           ...
           59,   64,   61,   65,   62,   66,   63,   67,   60,
    ];

    private $yygcheck = [
            5,   10,   -1,    5,    5,    5,    5,    5,    1,    1,
            8,    8,    9,    9,   11,   11,   14,   14,    7,
    ];

    private $yygbase = [
            0,    7,    0,    0,    0,   -3,    0,   14,    6,    8,
           -2,   10,    0,    0,   12,
    ];

    private $yygdefault = [
        -32768,   17,   18,   19,   20,   50,   69,   70,   76,   71,
           77,   72,   73,   12,   74,
    ];
