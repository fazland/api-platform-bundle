...
class PagerIteratorTest extends TestCase
{
    ...
    {
        $this->innerConnection->query('SELECT t0_.id AS id_0, t0_.timestamp AS timestamp_1 FROM TestObject t0_ ORDER BY t0_.timestamp ASC, t0_.id ASC LIMIT 3')
    ...
    {
        $this->innerConnection->prepare('SELECT t0_.id AS id_0, t0_.timestamp AS timestamp_1 FROM TestObject t0_ WHERE t0_.timestamp >= ? ORDER BY t0_.timestamp ASC, t0_.id ASC LIMIT 4')
    ...
    public function testOffsetShouldWork(): void
    {
        ...
        $this->innerConnection->prepare('SELECT t0_.id AS id_0, t0_.timestamp AS timestamp_1 FROM TestObject t0_ WHERE t0_.timestamp >= ? ORDER BY t0_.timestamp ASC, t0_.id ASC LIMIT 5')
            ->willReturn($stmt = $this->prophesize(Statement::class))
        ;
